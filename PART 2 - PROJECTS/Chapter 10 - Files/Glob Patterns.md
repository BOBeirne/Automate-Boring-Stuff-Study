...
p.glob('*') 
# <map object at 0x00000206A76EABC0>
list(p.glob('*')) 
# [WindowsPath('C:/Users/Al/Desktop/Python excersises/1.py'), WindowsPath('C:/Users/Al/Desktop/Python excersises/2.py'), WindowsPath('C:/Users/Al/Desktop/Python excersises/test.py')]
```

- `Glob` can also be used **in a loop**

```python
from pathlib import Path
for name in Path('C:/Users/Al/Desktop/Python excersises').glob('*'): # print out anything in the folder
	print(name)
