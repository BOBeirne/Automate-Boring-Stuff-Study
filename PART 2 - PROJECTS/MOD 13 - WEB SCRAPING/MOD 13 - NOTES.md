...
* ARIA Standard: ARIA defines roles (like button, link, checkbox, heading) that describe the purpose of an element to assistive technologies like screen readers.
