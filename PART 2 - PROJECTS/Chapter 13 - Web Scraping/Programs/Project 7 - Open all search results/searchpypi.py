...
link_elems = soup.select('a.package-snippet') # find all <a> elements with class="package-snippet__name", this is a pattern that all search result pages have in common *
...
# * while working through this book the package_snippet has been changed to package-snippet__name and embedded in <h3 class>, in order for code to run needs to be updated.
